...
SR300Node::SR300Node(rclcpp::Node node, rs2::device dev, const std::string& serial_no)
    : BaseRealSenseNode(node, privateNodeHandle, dev, serial_no)
{}
...
void SR300Node::setParam(sr300_paramsConfig &config, sr300_param param)
{
    ...
    case sr300_param_color_backlight_compensation:
        RCUTILS_LOG_DEBUG("sr300_param_color_backlight_compensation: " << config.sr300_color_backlight_compensation);
    ...
    case sr300_param_color_white_balance:
        RCUTILS_LOG_DEBUG("sr300_param_color_white_balance: " << config.sr300_color_white_balance);
    ...
    case sr300_param_color_enable_auto_white_balance:
        RCUTILS_LOG_DEBUG("rs435_depth_emitter_enabled: " << config.sr300_color_enable_auto_white_balance);
    ...
    case sr300_param_color_exposure:
        RCUTILS_LOG_DEBUG("sr300_param_color_exposure: " << config.sr300_color_exposure);
    ...
    case sr300_param_color_enable_auto_exposure:
        RCUTILS_LOG_DEBUG("sr300_param_color_enable_auto_exposure: " << config.sr300_color_enable_auto_white_balance);
    ...
    case sr300_param_depth_visual_preset:
        RCUTILS_LOG_DEBUG("sr300_param_color_enable_auto_exposure: " << config.sr300_depth_visual_preset);
    ...
    case sr300_param_depth_laser_power:
        RCUTILS_LOG_DEBUG("sr300_param_color_enable_auto_exposure: " << config.sr300_depth_laser_power);
    ...
    case sr300_param_depth_accuracy:
        RCUTILS_LOG_DEBUG("sr300_param_depth_accuracy: " << config.sr300_depth_accuracy);
        _sensors[DEPTH].set_option(rs2_option::RS2_OPTION_ACCURACY, config.sr300_depth_accuracy);
        break;
    case sr300_param_depth_motion_range:
        RCUTILS_LOG_DEBUG("sr300_param_depth_motion_range: " << config.sr300_depth_motion_range);
    ...
    case sr300_param_depth_filter_option:
        RCUTILS_LOG_DEBUG("sr300_param_depth_filter_option: " << config.sr300_depth_filter_option);
    ...
    case sr300_param_depth_confidence_threshold:
        RCUTILS_LOG_DEBUG("sr300_param_depth_confidence_threshold: " << config.sr300_depth_confidence_threshold);
    ...
    case sr300_param_depth_frames_queue_size:
        RCUTILS_LOG_DEBUG("sr300_param_depth_frames_queue_size: " << config.sr300_depth_frames_queue_size);
    ...
    case sr300_param_depth_units:
        break;
    default:
            RCUTILS_LOG_WARN("Unrecognized sr300 param (" << param << ")");
        break;
    }
...
void SR300Node::callback(sr300_paramsConfig &config, uint32_t level)
{
    ...
    if (set_default_dynamic_reconfig_values == level)
    {
        for (int i = 1 ; i < base_depth_count ; ++i)
        {
            ...
            {
                RCUTILS_LOG_ERROR("Failed. Skip initialization of parameter " << (sr300_param)i);
            }
        }
    }
    else

...
RS415Node::RS415Node(rclcpp::Node node,
...
void RS415Node::setParam(rs415_paramsConfig &config, rs415_param param)
{
    ...
    case rs415_color_backlight_compensation:
        RCUTILS_LOG_DEBUG("base_JSON_file_path: " << config.rs415_color_backlight_compensation);
    ...
    case rs415_color_enable_auto_exposure:
        RCUTILS_LOG_DEBUG("rs415_color_sharpness: " << config.rs415_color_enable_auto_exposure);
    ...
    case rs415_color_exposure:
        RCUTILS_LOG_DEBUG("rs415_color_exposure: " << config.rs415_color_exposure);
    ...
    case rs415_color_white_balance:
    {
        ...
        RCUTILS_LOG_DEBUG("rs415_color_white_balance: " << config.rs415_color_white_balance * rs415_color_white_balance_factor);
    ...
    case rs415_color_frames_queue_size:
        RCUTILS_LOG_DEBUG("rs415_color_frames_queue_size: " << config.rs415_color_frames_queue_size);
    ...
    case rs415_color_power_line_frequency:
        RCUTILS_LOG_DEBUG("rs415_color_power_line_frequency: " << config.rs415_color_power_line_frequency);
    ...
    case rs415_color_auto_exposure_priority:
        RCUTILS_LOG_DEBUG("rs415_color_power_line_frequency: " << config.rs415_color_auto_exposure_priority);
    ...
    case rs415_depth_exposure:
    {
        ...
        RCUTILS_LOG_DEBUG("rs415_depth_exposure: " << config.rs415_depth_exposure * rs415_depth_exposure_factor);
    ...
    case rs415_depth_laser_power:
    {
        ...
        RCUTILS_LOG_DEBUG("rs415_depth_laser_power: " << config.rs415_depth_laser_power * rs415_depth_laser_power_factor);
    ...
    case rs415_depth_emitter_enabled:
        RCUTILS_LOG_DEBUG("rs415_depth_emitter_enabled: " << config.rs415_depth_emitter_enabled);
        ...
        RCUTILS_LOG_DEBUG("rs415_depth_enable_auto_white_balance: " << config.rs415_depth_enable_auto_white_balance);
...
void RS415Node::callback(rs415_paramsConfig &config, uint32_t level)
{
    ...
    if (set_default_dynamic_reconfig_values == level)
    {
        for (int i = 1 ; i < base_depth_count ; ++i)
        {
            ...
            {
                RCUTILS_LOG_ERROR("Failed. Skip initialization of parameter " << (rs415_param)i);
            }
        }
    }
    else
